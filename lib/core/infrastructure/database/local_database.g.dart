...
class $LocalCourseGradeSimulatorTable extends LocalCourseGradeSimulator
    with TableInfo<$LocalCourseGradeSimulatorTable, CourseGradeSimulatorData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $LocalCourseGradeSimulatorTable(this.attachedDatabase, [this._alias]);
  ...
  @override
  $LocalCourseGradeSimulatorTable createAlias(String alias) {
    return $LocalCourseGradeSimulatorTable(attachedDatabase, alias);
  }
}
...
class CourseGradeSimulatorData extends DataClass
  ...
  LocalCourseGradeSimulatorCompanion toCompanion(bool nullToAbsent) {
    return LocalCourseGradeSimulatorCompanion(
      id: Value(id),
  ...
  CourseGradeSimulatorData copyWithCompanion(
    LocalCourseGradeSimulatorCompanion data,
  ) {
    return CourseGradeSimulatorData(
...
class LocalCourseGradeSimulatorCompanion
  ...
  const LocalCourseGradeSimulatorCompanion({
  ...
  LocalCourseGradeSimulatorCompanion.insert({
    this.id = const Value.absent(),
  ...
  LocalCourseGradeSimulatorCompanion copyWith({
    Value<String>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('LocalCourseGradeSimulatorCompanion(')
          ..write('id: $id, ')
          ..write('studentCode: $studentCode, ')
          ..write('courseCode: $courseCode, ')
          ..write('categories: $categories, ')
...
abstract class _$LocalDatabase extends GeneratedDatabase {
  ...
  late final $LocalCourseGradeSimulatorTable localCourseGradeSimulator =
      $LocalCourseGradeSimulatorTable(this);
  ...
  List<DatabaseSchemaEntity> get allSchemaEntities => [
    localCourseGradeSimulator,
    syncQueue,
  ];
}

typedef $$LocalCourseGradeSimulatorTableCreateCompanionBuilder =
    LocalCourseGradeSimulatorCompanion Function({
      Value<String> id,
      required String studentCode,
      required String courseCode,
      Value<String> categories,
...
typedef $$LocalCourseGradeSimulatorTableUpdateCompanionBuilder =
    LocalCourseGradeSimulatorCompanion Function({
      Value<String> id,
      Value<String> studentCode,
      Value<String> courseCode,
...
class $$LocalCourseGradeSimulatorTableFilterComposer
    extends Composer<_$LocalDatabase, $LocalCourseGradeSimulatorTable> {
  $$LocalCourseGradeSimulatorTableFilterComposer({
    required super.$db,
...
class $$LocalCourseGradeSimulatorTableOrderingComposer
    extends Composer<_$LocalDatabase, $LocalCourseGradeSimulatorTable> {
  $$LocalCourseGradeSimulatorTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LocalCourseGradeSimulatorTableAnnotationComposer
    extends Composer<_$LocalDatabase, $LocalCourseGradeSimulatorTable> {
  $$LocalCourseGradeSimulatorTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$LocalCourseGradeSimulatorTableTableManager
    extends
        RootTableManager<
          _$LocalDatabase,
          $LocalCourseGradeSimulatorTable,
          CourseGradeSimulatorData,
          $$LocalCourseGradeSimulatorTableFilterComposer,
          $$LocalCourseGradeSimulatorTableOrderingComposer,
          $$LocalCourseGradeSimulatorTableAnnotationComposer,
          $$LocalCourseGradeSimulatorTableCreateCompanionBuilder,
          $$LocalCourseGradeSimulatorTableUpdateCompanionBuilder,
          (
            CourseGradeSimulatorData,
            BaseReferences<
              _$LocalDatabase,
        ...
        > {
  $$LocalCourseGradeSimulatorTableTableManager(
    _$LocalDatabase db,
    $LocalCourseGradeSimulatorTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          ...
          updateCompanionCallback:
              ...
              }) => LocalCourseGradeSimulatorCompanion(
                id: id,
...
typedef $$LocalCourseGradeSimulatorTableProcessedTableManager =
...
class $LocalDatabaseManager {
  ...
  $$LocalCourseGradeSimulatorTableTableManager get localCourseGradeSimulator =>
      $$LocalCourseGradeSimulatorTableTableManager(
        _db,
        _db.localCourseGradeSimulator,
      );
