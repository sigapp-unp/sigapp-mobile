...
/// Adds pattern-matching-related methods to [StudentPageViewState].
extension StudentPageViewStatePatterns on StudentPageViewState {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  loading,TResult Function( AcademicInfoData data)?  success,TResult Function( Object error)?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case LoadingState() when loading != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  loading,required TResult Function( AcademicInfoData data)  success,required TResult Function( Object error)  error,}) {final _that = this;
switch (_that) {
case LoadingState():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  loading,TResult? Function( AcademicInfoData data)?  success,TResult? Function( Object error)?  error,}) {final _that = this;
switch (_that) {
case LoadingState() when loading != null:
return loading();case SuccessState() when success != null:
return success(_that.data);case ErrorState() when error != null:
