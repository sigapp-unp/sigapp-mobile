...
/// Adds pattern-matching-related methods to [CourseVisibilityState].
extension CourseVisibilityStatePatterns on CourseVisibilityState {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _CourseVisibilityState value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _CourseVisibilityState() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _CourseVisibilityState value)  $default,){
final _that = this;
switch (_that) {
case _CourseVisibilityState():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _CourseVisibilityState value)?  $default,){
final _that = this;
switch (_that) {
case _CourseVisibilityState() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool isLoading,  Map<String, bool> hiddenEvents)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _CourseVisibilityState() when $default != null:
return $default(_that.isLoading,_that.hiddenEvents);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool isLoading,  Map<String, bool> hiddenEvents)  $default,) {final _that = this;
switch (_that) {
case _CourseVisibilityState():
return $default(_that.isLoading,_that.hiddenEvents);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool isLoading,  Map<String, bool> hiddenEvents)?  $default,) {final _that = this;
switch (_that) {
case _CourseVisibilityState() when $default != null:
return $default(_that.isLoading,_that.hiddenEvents);case _:
  return null;
